...
components =
  Dict.fromList
    ...
    , ("native_browser", ("Ui.Native.Browser", False))
    , ("native_dom", ("Ui.Native.Dom", False))
    , ("native_local-storage", ("Ui.Native.LocalStorage", False))
    , ("helpers_drag", ("Ui.Helpers.Drag", False))
    , ("helpers_emitter", ("Ui.Helpers.Emitter", False))
    , ("helpers_env", ("Ui.Helpers.Env", False))
    , ("helpers_dropdown", ("Ui.Helpers.Dropdown", False))
    , ("helpers_intendable", ("Ui.Helpers.Intendable", False))
    ]
